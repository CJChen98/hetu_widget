...
class CustomPainterAutoBinding extends HTExternalClass {
  CustomPainterAutoBinding() : super(r'CustomPainter');


  @override
  dynamic instanceMemberGet(dynamic object, String varName) {
    return (object as CustomPainter).htFetch(varName);
  }
...
extension CustomPainterBinding on CustomPainter {
  dynamic htFetch(String varName) {
    switch (varName) {
      case r'typeid':
        return const HTExternalType(r'CustomPainter');
...
class CustomPainterSemanticsAutoBinding extends HTExternalClass {
  CustomPainterSemanticsAutoBinding() : super(r'CustomPainterSemantics');

  @override
  dynamic memberGet(String varName, {String? from}) {
    switch (varName) {
      case r'CustomPainterSemantics':
        return (HTEntity entity,
            {List<dynamic> positionalArgs = const [],
              Map<String, dynamic> namedArgs = const {},
              List<HTType> typeArgs = const []}) => CustomPainterSemantics(key : namedArgs.containsKey('key') ? namedArgs['key'] : null, rect : namedArgs['rect'], properties : namedArgs['properties'], transform : namedArgs.containsKey('transform') ? namedArgs['transform'] : null, tags : namedArgs.containsKey('tags') ? namedArgs['tags'] : null);
      default:
        throw HTError.undefined(varName);
    }
  }
  ...
  @override
  dynamic instanceMemberGet(dynamic object, String varName) {
    return (object as CustomPainterSemantics).htFetch(varName);
  }
...
extension CustomPainterSemanticsBinding on CustomPainterSemantics {
  dynamic htFetch(String varName) {
    switch (varName) {
      case r'typeid':
        return const HTExternalType(r'CustomPainterSemantics');
      case r'key':
        return key;
      case r'rect':
        return rect;
...
class RenderCustomPaintAutoBinding extends HTExternalClass {
  RenderCustomPaintAutoBinding() : super(r'RenderCustomPaint');

  @override
  dynamic memberGet(String varName, {String? from}) {
    switch (varName) {
      case r'RenderCustomPaint':
        return (HTEntity entity,
            {List<dynamic> positionalArgs = const [],
              Map<String, dynamic> namedArgs = const {},
              List<HTType> typeArgs = const []}) => RenderCustomPaint(painter : namedArgs.containsKey('painter') ? namedArgs['painter'] : null, foregroundPainter : namedArgs.containsKey('foregroundPainter') ? namedArgs['foregroundPainter'] : null, preferredSize : namedArgs.containsKey('preferredSize') ? namedArgs['preferredSize'] : Size.zero, isComplex : namedArgs.containsKey('isComplex') ? namedArgs['isComplex'] : false, willChange : namedArgs.containsKey('willChange') ? namedArgs['willChange'] : false, child : namedArgs.containsKey('child') ? namedArgs['child'] : null);
      default:
        throw HTError.undefined(varName);
    }
  }
  ...
  @override
  dynamic instanceMemberGet(dynamic object, String varName) {
    return (object as RenderCustomPaint).htFetch(varName);
  }

  @override
  void instanceMemberSet(dynamic object, String varName, dynamic varValue) {
    (object as RenderCustomPaint).htAssign(varName, varValue);
  }
...
extension RenderCustomPaintBinding on RenderCustomPaint {
  dynamic htFetch(String varName) {
    switch (varName) {
      case r'typeid':
        return const HTExternalType(r'RenderCustomPaint');
      case r'isComplex':
        return isComplex;
      case r'willChange':
        return willChange;
