...
extension SliderThemeDataBinding on SliderThemeData {
  dynamic htFetch(String varName) {
    switch (varName) {
      ...
      case r'secondaryActiveTrackColor':
        return secondaryActiveTrackColor;
      case r'disabledActiveTrackColor':
        return disabledActiveTrackColor;
      case r'disabledSecondaryActiveTrackColor':
        return disabledSecondaryActiveTrackColor;
    ...
    switch (varName) {
      ...
      case r'paint':
        return (HTEntity entity,
            {List<dynamic> positionalArgs = const [],
              Map<String, dynamic> namedArgs = const {},
              List<HTType> typeArgs = const []}) => this.paint(positionalArgs[0], positionalArgs[1], parentBox : namedArgs['parentBox'], sliderTheme : namedArgs['sliderTheme'], enableAnimation : namedArgs['enableAnimation'], thumbCenter : namedArgs['thumbCenter'], secondaryOffset : namedArgs['secondaryOffset'], isEnabled : namedArgs['isEnabled'], isDiscrete : namedArgs['isDiscrete'], textDirection : namedArgs['textDirection']);
      default:
        throw HTError.undefined(varName);
    }
  }
    ...
    switch (varName) {
      ...
      case r'paint':
        return (HTEntity entity,
            {List<dynamic> positionalArgs = const [],
              Map<String, dynamic> namedArgs = const {},
              List<HTType> typeArgs = const []}) => this.paint(positionalArgs[0], positionalArgs[1], parentBox : namedArgs['parentBox'], sliderTheme : namedArgs['sliderTheme'], enableAnimation : namedArgs['enableAnimation'], textDirection : namedArgs['textDirection'], thumbCenter : namedArgs['thumbCenter'], secondaryOffset : namedArgs['secondaryOffset'], isDiscrete : namedArgs.containsKey('isDiscrete') ? namedArgs['isDiscrete'] : false, isEnabled : namedArgs.containsKey('isEnabled') ? namedArgs['isEnabled'] : false);
      case r'getPreferredRect':
        return (HTEntity entity,
            {List<dynamic> positionalArgs = const [],
              Map<String, dynamic> namedArgs = const {},
    ...
    switch (varName) {
      ...
      case r'paint':
        return (HTEntity entity,
            {List<dynamic> positionalArgs = const [],
              Map<String, dynamic> namedArgs = const {},
              List<HTType> typeArgs = const []}) => this.paint(positionalArgs[0], positionalArgs[1], parentBox : namedArgs['parentBox'], sliderTheme : namedArgs['sliderTheme'], enableAnimation : namedArgs['enableAnimation'], textDirection : namedArgs['textDirection'], thumbCenter : namedArgs['thumbCenter'], secondaryOffset : namedArgs['secondaryOffset'], isDiscrete : namedArgs.containsKey('isDiscrete') ? namedArgs['isDiscrete'] : false, isEnabled : namedArgs.containsKey('isEnabled') ? namedArgs['isEnabled'] : false, additionalActiveTrackHeight : namedArgs.containsKey('additionalActiveTrackHeight') ? namedArgs['additionalActiveTrackHeight'] : 2);
      case r'getPreferredRect':
        return (HTEntity entity,
            {List<dynamic> positionalArgs = const [],
              Map<String, dynamic> namedArgs = const {},
