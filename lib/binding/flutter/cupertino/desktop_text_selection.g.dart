...
class CupertinoDesktopTextSelectionControlsAutoBinding extends HTExternalClass {
  CupertinoDesktopTextSelectionControlsAutoBinding() : super(r'CupertinoDesktopTextSelectionControls');

  @override
  dynamic memberGet(String varName, {String? from}) {
    switch (varName) {
      case r'CupertinoDesktopTextSelectionControls':
        return (HTEntity entity,
            {List<dynamic> positionalArgs = const [],
              Map<String, dynamic> namedArgs = const {},
              List<HTType> typeArgs = const []}) => CupertinoDesktopTextSelectionControls();
      default:
  ...
  dynamic instanceMemberGet(dynamic object, String varName) {
    return (object as CupertinoDesktopTextSelectionControls).htFetch(varName);
  }
...
extension CupertinoDesktopTextSelectionControlsBinding on CupertinoDesktopTextSelectionControls {
  dynamic htFetch(String varName) {
    switch (varName) {
      case r'typeid':
        return const HTExternalType(r'CupertinoDesktopTextSelectionControls');
