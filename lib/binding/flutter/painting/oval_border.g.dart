...
class OvalBorderAutoBinding extends HTExternalClass {
  OvalBorderAutoBinding() : super(r'OvalBorder');
      ...
      case r'OvalBorder':
        return (HTEntity entity,
            {List<dynamic> positionalArgs = const [],
              ...
              List<HTType> typeArgs = const []}) => OvalBorder(side : namedArgs.containsKey('side') ? namedArgs['side'] : BorderSide.none, eccentricity : namedArgs.containsKey('eccentricity') ? namedArgs['eccentricity'] : 1.0);
      default:
  ...
  dynamic instanceMemberGet(dynamic object, String varName) {
    return (object as OvalBorder).htFetch(varName);
  }
...
extension OvalBorderBinding on OvalBorder {
  dynamic htFetch(String varName) {
    switch (varName) {
      case r'typeid':
        return const HTExternalType(r'OvalBorder');
      case r'eccentricity':
        return eccentricity;
      case r'side':
        return side;
