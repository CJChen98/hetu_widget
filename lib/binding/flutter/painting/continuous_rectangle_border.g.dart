...
class ContinuousRectangleBorderAutoBinding extends HTExternalClass {
  ContinuousRectangleBorderAutoBinding() : super(r'ContinuousRectangleBorder');
      ...
      case r'ContinuousRectangleBorder':
        return (HTEntity entity,
            {List<dynamic> positionalArgs = const [],
              ...
              List<HTType> typeArgs = const []}) => ContinuousRectangleBorder(side : namedArgs.containsKey('side') ? namedArgs['side'] : BorderSide.none, borderRadius : namedArgs.containsKey('borderRadius') ? namedArgs['borderRadius'] : BorderRadius.zero);
      default:
  ...
  dynamic instanceMemberGet(dynamic object, String varName) {
    return (object as ContinuousRectangleBorder).htFetch(varName);
  }
...
extension ContinuousRectangleBorderBinding on ContinuousRectangleBorder {
  dynamic htFetch(String varName) {
    switch (varName) {
      case r'typeid':
        return const HTExternalType(r'ContinuousRectangleBorder');
      case r'borderRadius':
        return borderRadius;
      case r'side':
        return side;
