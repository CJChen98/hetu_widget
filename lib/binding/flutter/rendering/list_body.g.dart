...
class ListBodyParentDataAutoBinding extends HTExternalClass {
  ListBodyParentDataAutoBinding() : super(r'ListBodyParentData');

  @override
  dynamic memberGet(String varName, {String? from}) {
    switch (varName) {
      case r'ListBodyParentData':
        return (HTEntity entity,
            {List<dynamic> positionalArgs = const [],
              Map<String, dynamic> namedArgs = const {},
              List<HTType> typeArgs = const []}) => ListBodyParentData();
      default:
  ...
  dynamic instanceMemberGet(dynamic object, String varName) {
    return (object as ListBodyParentData).htFetch(varName);
  }

  @override
  void instanceMemberSet(dynamic object, String varName, dynamic varValue) {
    (object as ListBodyParentData).htAssign(varName, varValue);
  }
...
extension ListBodyParentDataBinding on ListBodyParentData {
  dynamic htFetch(String varName) {
    switch (varName) {
      case r'typeid':
        return const HTExternalType(r'ListBodyParentData');
      case r'offset':
        return offset;
      case r'toString':
        return (HTEntity entity,
...
class RenderListBodyAutoBinding extends HTExternalClass {
  RenderListBodyAutoBinding() : super(r'RenderListBody');

  @override
  dynamic memberGet(String varName, {String? from}) {
    switch (varName) {
      case r'RenderListBody':
        return (HTEntity entity,
            {List<dynamic> positionalArgs = const [],
              Map<String, dynamic> namedArgs = const {},
              List<HTType> typeArgs = const []}) => RenderListBody(children : namedArgs.containsKey('children') ? List<RenderBox>.from(namedArgs['children']) : null, axisDirection : namedArgs.containsKey('axisDirection') ? namedArgs['axisDirection'] : AxisDirection.down);
      default:
        throw HTError.undefined(varName);
    }
  }
  ...
  @override
  dynamic instanceMemberGet(dynamic object, String varName) {
    return (object as RenderListBody).htFetch(varName);
  }

  @override
  void instanceMemberSet(dynamic object, String varName, dynamic varValue) {
    (object as RenderListBody).htAssign(varName, varValue);
  }
...
extension RenderListBodyBinding on RenderListBody {
  dynamic htFetch(String varName) {
    switch (varName) {
      case r'typeid':
        return const HTExternalType(r'RenderListBody');
