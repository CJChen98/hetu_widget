...
class StackFitAutoBinding extends HTExternalClass {
  StackFitAutoBinding() : super(r'StackFit');
  ...
  dynamic memberGet(String varName, {String? from}) {
    switch (varName) {
      ...
      case r'StackFit.loose':
        return StackFit.loose;
      case r'StackFit.expand':
        return StackFit.expand;
      case r'StackFit.passthrough':
  ...
  dynamic instanceMemberGet(dynamic object, String varName) {
    switch (varName) {
      case r'typeid':
        return const HTExternalType(r'StackFit');
      case r'index':
        return (object as StackFit).index;
      case r'toString':
        return (HTEntity entity,
            {List<dynamic> positionalArgs = const [],
              Map<String, dynamic> namedArgs = const {},
              List<HTType> typeArgs = const []}) => (object as StackFit).toString();
      default:
        throw HTError.undefined(varName);
    }
  }
...
class RelativeRectAutoBinding extends HTExternalClass {
  RelativeRectAutoBinding() : super(r'RelativeRect');

  @override
  dynamic memberGet(String varName, {String? from}) {
    switch (varName) {
      case r'RelativeRect.fromLTRB':
        return (HTEntity entity,
            {List<dynamic> positionalArgs = const [],
              Map<String, dynamic> namedArgs = const {},
              List<HTType> typeArgs = const []}) => RelativeRect.fromLTRB(positionalArgs[0], positionalArgs[1], positionalArgs[2], positionalArgs[3]);
      case r'RelativeRect.fromSize':
        return (HTEntity entity,
            {List<dynamic> positionalArgs = const [],
              Map<String, dynamic> namedArgs = const {},
              List<HTType> typeArgs = const []}) => RelativeRect.fromSize(positionalArgs[0], positionalArgs[1]);
      case r'RelativeRect.fromRect':
        return (HTEntity entity,
            {List<dynamic> positionalArgs = const [],
              Map<String, dynamic> namedArgs = const {},
              List<HTType> typeArgs = const []}) => RelativeRect.fromRect(positionalArgs[0], positionalArgs[1]);
      case r'RelativeRect.fromDirectional':
        return (HTEntity entity,
            {List<dynamic> positionalArgs = const [],
              Map<String, dynamic> namedArgs = const {},
              List<HTType> typeArgs = const []}) => RelativeRect.fromDirectional(textDirection : namedArgs['textDirection'], start : namedArgs['start'], top : namedArgs['top'], end : namedArgs['end'], bottom : namedArgs['bottom']);
      case r'RelativeRect.lerp':
        return (HTEntity entity,
            {List<dynamic> positionalArgs = const [],
              Map<String, dynamic> namedArgs = const {},
              List<HTType> typeArgs = const []}) => RelativeRect.lerp(positionalArgs[0], positionalArgs[1], positionalArgs[2]);
      case r'RelativeRect.fill':
  ...
  @override
  dynamic instanceMemberGet(dynamic object, String varName) {
    return (object as RelativeRect).htFetch(varName);
  }
...
extension RelativeRectBinding on RelativeRect {
  dynamic htFetch(String varName) {
    switch (varName) {
      case r'typeid':
        return const HTExternalType(r'RelativeRect');
      case r'left':
        return left;
      case r'top':
        return top;
      ...
      case r'toRect':
        return (HTEntity entity,
            {List<dynamic> positionalArgs = const [],
              Map<String, dynamic> namedArgs = const {},
              List<HTType> typeArgs = const []}) => this.toRect(positionalArgs[0]);
      case r'toSize':
        return (HTEntity entity,
            {List<dynamic> positionalArgs = const [],
              Map<String, dynamic> namedArgs = const {},
              List<HTType> typeArgs = const []}) => this.toSize(positionalArgs[0]);
      case r'toString':
        return (HTEntity entity,
            {List<dynamic> positionalArgs = const [],
              Map<String, dynamic> namedArgs = const {},
...
class StackParentDataAutoBinding extends HTExternalClass {
  StackParentDataAutoBinding() : super(r'StackParentData');

  @override
  dynamic memberGet(String varName, {String? from}) {
    switch (varName) {
      case r'StackParentData':
        return (HTEntity entity,
            {List<dynamic> positionalArgs = const [],
              Map<String, dynamic> namedArgs = const {},
              List<HTType> typeArgs = const []}) => StackParentData();
      default:
        throw HTError.undefined(varName);
    }
  }
  ...
  @override
  dynamic instanceMemberGet(dynamic object, String varName) {
    return (object as StackParentData).htFetch(varName);
  }

  @override
  void instanceMemberSet(dynamic object, String varName, dynamic varValue) {
    (object as StackParentData).htAssign(varName, varValue);
  }
...
extension StackParentDataBinding on StackParentData {
  dynamic htFetch(String varName) {
    switch (varName) {
      case r'typeid':
        return const HTExternalType(r'StackParentData');
      case r'top':
        return top;
      case r'right':
        return right;
...
class RenderStackAutoBinding extends HTExternalClass {
  RenderStackAutoBinding() : super(r'RenderStack');
  ...
  @override
  dynamic instanceMemberGet(dynamic object, String varName) {
    return (object as RenderStack).htFetch(varName);
  }

  @override
  void instanceMemberSet(dynamic object, String varName, dynamic varValue) {
    (object as RenderStack).htAssign(varName, varValue);
  }
...
extension RenderStackBinding on RenderStack {
  dynamic htFetch(String varName) {
    switch (varName) {
      case r'typeid':
        return const HTExternalType(r'RenderStack');
      case r'alignment':
        return alignment;
...
class RenderIndexedStackAutoBinding extends HTExternalClass {
  RenderIndexedStackAutoBinding() : super(r'RenderIndexedStack');

  @override
  dynamic memberGet(String varName, {String? from}) {
    switch (varName) {
      case r'RenderIndexedStack':
        return (HTEntity entity,
            {List<dynamic> positionalArgs = const [],
              Map<String, dynamic> namedArgs = const {},
  ...
  @override
  dynamic instanceMemberGet(dynamic object, String varName) {
    return (object as RenderIndexedStack).htFetch(varName);
  }

  @override
  void instanceMemberSet(dynamic object, String varName, dynamic varValue) {
    (object as RenderIndexedStack).htAssign(varName, varValue);
  }
...
extension RenderIndexedStackBinding on RenderIndexedStack {
  dynamic htFetch(String varName) {
    switch (varName) {
      case r'typeid':
        return const HTExternalType(r'RenderIndexedStack');
      case r'index':
        return index;
      case r'alignment':
        return alignment;
      ...
      case r'paintStack':
        return (HTEntity entity,
            {List<dynamic> positionalArgs = const [],
              Map<String, dynamic> namedArgs = const {},
              List<HTType> typeArgs = const []}) => this.paintStack(positionalArgs[0], positionalArgs[1]);
      case r'debugFillProperties':
        return (HTEntity entity,
            {List<dynamic> positionalArgs = const [],
              Map<String, dynamic> namedArgs = const {},
