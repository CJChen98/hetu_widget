...
class RenderRotatedBoxAutoBinding extends HTExternalClass {
  RenderRotatedBoxAutoBinding() : super(r'RenderRotatedBox');

  @override
  dynamic memberGet(String varName, {String? from}) {
    switch (varName) {
      case r'RenderRotatedBox':
        return (HTEntity entity,
            {List<dynamic> positionalArgs = const [],
              Map<String, dynamic> namedArgs = const {},
              List<HTType> typeArgs = const []}) => RenderRotatedBox(quarterTurns : namedArgs['quarterTurns'], child : namedArgs.containsKey('child') ? namedArgs['child'] : null);
      default:
  ...
  dynamic instanceMemberGet(dynamic object, String varName) {
    return (object as RenderRotatedBox).htFetch(varName);
  }

  @override
  void instanceMemberSet(dynamic object, String varName, dynamic varValue) {
    (object as RenderRotatedBox).htAssign(varName, varValue);
  }
...
extension RenderRotatedBoxBinding on RenderRotatedBox {
  dynamic htFetch(String varName) {
    switch (varName) {
      case r'typeid':
        return const HTExternalType(r'RenderRotatedBox');
      case r'quarterTurns':
        return quarterTurns;
      case r'hasSize':
        return hasSize;
