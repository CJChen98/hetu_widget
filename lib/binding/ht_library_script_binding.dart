...
import 'flutter/scheduler/service_extensions.g.dart';
...
import 'flutter/foundation/memory_allocations.g.dart';
...
import 'flutter/foundation/service_extensions.g.dart';
...
import 'flutter/painting/star_border.g.dart';
...
import 'flutter/painting/oval_border.g.dart';
...
import 'flutter/rendering/service_extensions.g.dart';
...
import 'flutter/material/action_chip.g.dart';
...
import 'flutter/material/filter_chip.g.dart';
...
import 'flutter/material/filled_button.g.dart';
...
import 'flutter/material/input_chip.g.dart';
import 'flutter/material/filled_button_theme.g.dart';
...
import 'flutter/material/choice_chip.g.dart';
...
import 'flutter/material/icon_button_theme.g.dart';
import 'flutter/material/drawer.g.dart';
import 'flutter/material/desktop_text_selection.g.dart';
import 'flutter/material/expansion_tile_theme.g.dart';
import 'flutter/material/date.g.dart';
import 'flutter/material/magnifier.g.dart';
...
import 'flutter/services/spell_check.g.dart';
...
import 'flutter/services/text_boundary.g.dart';
...
import 'flutter/services/service_extensions.g.dart';
...
import 'flutter/widgets/tap_region.g.dart';
import 'flutter/widgets/spell_check.g.dart';
...
import 'flutter/widgets/snapshot_widget.g.dart';
...
import 'flutter/widgets/magnifier.g.dart';
...
import 'flutter/widgets/service_extensions.g.dart';
...
class HetuLibraryScriptBinding {
  ...
  void loadAutoBindingFunction(Hetu hetu) {
    ...
    functionWrappers.addAll(MemoryAllocationsAutoBinding.functionWrapper());
    ...
    functionWrappers.addAll(CupertinoDesktopTextSelectionControlsAutoBinding.functionWrapper());
    ...
    functionWrappers.addAll(FilledButtonAutoBinding.functionWrapper());
    ...
    functionWrappers.addAll(DesktopTextSelectionControlsAutoBinding.functionWrapper());
    ...
    functionWrappers.addAll(TapRegionAutoBinding.functionWrapper());
    functionWrappers.addAll(RenderTapRegionAutoBinding.functionWrapper());
    ...
    functionWrappers.addAll(SnapshotControllerAutoBinding.functionWrapper());
    functionWrappers.addAll(SnapshotPainterAutoBinding.functionWrapper());
    ...
    functionWrappers.addAll(EmptyTextSelectionControlsAutoBinding.functionWrapper());
    ...
    functionWrappers.addAll(TextMagnifierConfigurationAutoBinding.functionWrapper());
    functionWrappers.addAll(MagnifierControllerAutoBinding.functionWrapper());
    functionWrappers.addAll(MagnifierDecorationAutoBinding.functionWrapper());
  ...
  void loadAutoBindingClass(Hetu hetu) {
    var bindings = [
      ...
      PriorityAutoBinding(),
      SchedulerServiceExtensionsAutoBinding(),
      ...
      ObjectEventAutoBinding(),
      ObjectCreatedAutoBinding(),
      ObjectDisposedAutoBinding(),
      MemoryAllocationsAutoBinding(),
      ...
      PointerScrollInertiaCancelEventAutoBinding(),
      ...
      RenderingServiceExtensionsAutoBinding(),
      ...
      CupertinoListTileAutoBinding(),
      CupertinoListTileChevronAutoBinding(),
      CupertinoTextSelectionControlsAutoBinding(),
      CupertinoListSectionAutoBinding(),
      CupertinoListSectionTypeAutoBinding(),
      CupertinoUserInterfaceLevelAutoBinding(),
      CupertinoUserInterfaceLevelDataAutoBinding(),
      CupertinoFormSectionAutoBinding(),
      CupertinoDesktopTextSelectionControlsAutoBinding(),
      CupertinoTextFormFieldRowAutoBinding(),
      CupertinoTextMagnifierAutoBinding(),
      CupertinoMagnifierAutoBinding(),
      ...
      FilledButtonThemeDataAutoBinding(),
      FilledButtonThemeAutoBinding(),
      ...
      IconButtonThemeDataAutoBinding(),
      IconButtonThemeAutoBinding(),
      DrawerAutoBinding(),
      DrawerControllerAutoBinding(),
      DrawerControllerStateAutoBinding(),
      DrawerAlignmentAutoBinding(),
      DesktopTextSelectionControlsAutoBinding(),
      ...
      TextMagnifierAutoBinding(),
      MagnifierAutoBinding(),
      ...
      SuggestionSpanAutoBinding(),
      SpellCheckResultsAutoBinding(),
      SpellCheckServiceAutoBinding(),
      DefaultSpellCheckServiceAutoBinding(),
      ...
      TextBoundaryAutoBinding(),
      CharacterBoundaryAutoBinding(),
      WordBoundaryAutoBinding(),
      LineBreakAutoBinding(),
      DocumentBoundaryAutoBinding(),
      ...
      ServicesServiceExtensionsAutoBinding(),
      ...
      TapRegionRegistryAutoBinding(),
      TapRegionSurfaceAutoBinding(),
      RenderTapRegionSurfaceAutoBinding(),
      TapRegionAutoBinding(),
      RenderTapRegionAutoBinding(),
      TextFieldTapRegionAutoBinding(),
      SpellCheckConfigurationAutoBinding(),
      ...
      SnapshotControllerAutoBinding(),
      SnapshotWidgetAutoBinding(),
      SnapshotPainterAutoBinding(),
      SnapshotModeAutoBinding(),
      ...
      EmptyTextSelectionControlsAutoBinding(),
      ...
      MagnifierOverlayInfoBearerAutoBinding(),
      TextMagnifierConfigurationAutoBinding(),
      MagnifierControllerAutoBinding(),
      MagnifierDecorationAutoBinding(),
      RawMagnifierAutoBinding(),
      ...
      WidgetsServiceExtensionsAutoBinding(),
      WidgetInspectorServiceExtensionsAutoBinding(),
