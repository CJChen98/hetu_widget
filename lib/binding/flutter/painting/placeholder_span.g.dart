...
class PlaceholderSpanAutoBinding extends HTExternalClass {
  PlaceholderSpanAutoBinding() : super(r'PlaceholderSpan');

  @override
  dynamic memberGet(String varName, {String? from}) {
    switch (varName) {
      case r'PlaceholderSpan.placeholderCodeUnit':
  ...
  dynamic instanceMemberGet(dynamic object, String varName) {
    return (object as PlaceholderSpan).htFetch(varName);
  }
...
extension PlaceholderSpanBinding on PlaceholderSpan {
  dynamic htFetch(String varName) {
    switch (varName) {
      case r'typeid':
        return const HTExternalType(r'PlaceholderSpan');
      case r'alignment':
        return alignment;
      case r'baseline':
        return baseline;
