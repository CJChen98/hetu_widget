...
class StringBufferAutoBinding extends HTExternalClass {
  StringBufferAutoBinding() : super(r'StringBuffer');
      ...
      case r'StringBuffer':
        return (HTEntity entity,
            {List<dynamic> positionalArgs = const [],
              ...
              List<HTType> typeArgs = const []}) => StringBuffer(positionalArgs.length > 0 ? positionalArgs[0] : "");
      default:
  ...
  dynamic instanceMemberGet(dynamic object, String varName) {
    return (object as StringBuffer).htFetch(varName);
  }
...
extension StringBufferBinding on StringBuffer {
  dynamic htFetch(String varName) {
    switch (varName) {
      case r'typeid':
        return const HTExternalType(r'StringBuffer');
      case r'length':
        return length;
      case r'isEmpty':
        return isEmpty;
