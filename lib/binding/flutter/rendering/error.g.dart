...
class RenderErrorBoxAutoBinding extends HTExternalClass {
  RenderErrorBoxAutoBinding() : super(r'RenderErrorBox');

  @override
  dynamic memberGet(String varName, {String? from}) {
    switch (varName) {
      case r'RenderErrorBox':
        return (HTEntity entity,
            {List<dynamic> positionalArgs = const [],
              Map<String, dynamic> namedArgs = const {},
              List<HTType> typeArgs = const []}) => RenderErrorBox(positionalArgs.length > 0 ? positionalArgs[0] : '');
      case r'RenderErrorBox.padding':
        return RenderErrorBox.padding;
      case r'RenderErrorBox.minimumWidth':
        return RenderErrorBox.minimumWidth;
      case r'RenderErrorBox.backgroundColor':
        return RenderErrorBox.backgroundColor;
      case r'RenderErrorBox.textStyle':
        return RenderErrorBox.textStyle;
      case r'RenderErrorBox.paragraphStyle':
  ...
  dynamic instanceMemberGet(dynamic object, String varName) {
    return (object as RenderErrorBox).htFetch(varName);
  }
...
extension RenderErrorBoxBinding on RenderErrorBox {
  dynamic htFetch(String varName) {
    switch (varName) {
      case r'typeid':
        return const HTExternalType(r'RenderErrorBox');
      case r'message':
        return message;
