...
class ChoiceChipAutoBinding extends HTExternalClass {
  ChoiceChipAutoBinding() : super(r'ChoiceChip');
  ...
  dynamic instanceMemberGet(dynamic object, String varName) {
    return (object as ChoiceChip).htFetch(varName);
  }
...
extension ChoiceChipBinding on ChoiceChip {
  dynamic htFetch(String varName) {
    switch (varName) {
      case r'typeid':
        return const HTExternalType(r'ChoiceChip');
      case r'avatar':
        return avatar;
      case r'label':
        return label;
