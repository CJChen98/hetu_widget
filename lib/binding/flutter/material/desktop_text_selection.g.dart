...
class DesktopTextSelectionControlsAutoBinding extends HTExternalClass {
  DesktopTextSelectionControlsAutoBinding() : super(r'DesktopTextSelectionControls');

  @override
  dynamic memberGet(String varName, {String? from}) {
    switch (varName) {
      case r'DesktopTextSelectionControls':
        return (HTEntity entity,
            {List<dynamic> positionalArgs = const [],
              Map<String, dynamic> namedArgs = const {},
              List<HTType> typeArgs = const []}) => DesktopTextSelectionControls();
      default:
  ...
  dynamic instanceMemberGet(dynamic object, String varName) {
    return (object as DesktopTextSelectionControls).htFetch(varName);
  }
...
extension DesktopTextSelectionControlsBinding on DesktopTextSelectionControls {
  dynamic htFetch(String varName) {
    switch (varName) {
      case r'typeid':
        return const HTExternalType(r'DesktopTextSelectionControls');
