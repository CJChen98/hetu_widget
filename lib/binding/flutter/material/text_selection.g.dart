...
class MaterialTextSelectionControlsAutoBinding extends HTExternalClass {
  MaterialTextSelectionControlsAutoBinding() : super(r'MaterialTextSelectionControls');

  @override
  dynamic memberGet(String varName, {String? from}) {
    switch (varName) {
      case r'MaterialTextSelectionControls':
        return (HTEntity entity,
            {List<dynamic> positionalArgs = const [],
              Map<String, dynamic> namedArgs = const {},
              List<HTType> typeArgs = const []}) => MaterialTextSelectionControls();
      default:
  ...
  dynamic instanceMemberGet(dynamic object, String varName) {
    return (object as MaterialTextSelectionControls).htFetch(varName);
  }
...
extension MaterialTextSelectionControlsBinding on MaterialTextSelectionControls {
  dynamic htFetch(String varName) {
    switch (varName) {
      case r'typeid':
        return const HTExternalType(r'MaterialTextSelectionControls');
