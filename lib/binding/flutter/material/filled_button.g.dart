...
class FilledButtonAutoBinding extends HTExternalClass {
  FilledButtonAutoBinding() : super(r'FilledButton');
  ...
  dynamic instanceMemberGet(dynamic object, String varName) {
    return (object as FilledButton).htFetch(varName);
  }
...
extension FilledButtonBinding on FilledButton {
  dynamic htFetch(String varName) {
    switch (varName) {
      case r'typeid':
        return const HTExternalType(r'FilledButton');
      case r'onPressed':
        return onPressed;
      case r'onLongPress':
        return onLongPress;
