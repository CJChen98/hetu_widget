...
class RenderSliverFixedExtentBoxAdaptorAutoBinding extends HTExternalClass {
  RenderSliverFixedExtentBoxAdaptorAutoBinding() : super(r'RenderSliverFixedExtentBoxAdaptor');


  @override
  dynamic instanceMemberGet(dynamic object, String varName) {
    return (object as RenderSliverFixedExtentBoxAdaptor).htFetch(varName);
  }
...
extension RenderSliverFixedExtentBoxAdaptorBinding on RenderSliverFixedExtentBoxAdaptor {
  dynamic htFetch(String varName) {
    switch (varName) {
      case r'typeid':
        return const HTExternalType(r'RenderSliverFixedExtentBoxAdaptor');
      case r'itemExtent':
        return itemExtent;
...
class RenderSliverFixedExtentListAutoBinding extends HTExternalClass {
  RenderSliverFixedExtentListAutoBinding() : super(r'RenderSliverFixedExtentList');

  @override
  dynamic memberGet(String varName, {String? from}) {
    switch (varName) {
      case r'RenderSliverFixedExtentList':
        return (HTEntity entity,
            {List<dynamic> positionalArgs = const [],
              Map<String, dynamic> namedArgs = const {},
              List<HTType> typeArgs = const []}) => RenderSliverFixedExtentList(childManager : namedArgs['childManager'], itemExtent : namedArgs['itemExtent']);
      default:
        throw HTError.undefined(varName);
    }
  }
  ...
  @override
  dynamic instanceMemberGet(dynamic object, String varName) {
    return (object as RenderSliverFixedExtentList).htFetch(varName);
  }

  @override
  void instanceMemberSet(dynamic object, String varName, dynamic varValue) {
    (object as RenderSliverFixedExtentList).htAssign(varName, varValue);
  }
...
extension RenderSliverFixedExtentListBinding on RenderSliverFixedExtentList {
  dynamic htFetch(String varName) {
    switch (varName) {
      case r'typeid':
        return const HTExternalType(r'RenderSliverFixedExtentList');
      case r'itemExtent':
        return itemExtent;
      case r'debugChildIntegrityEnabled':
        return debugChildIntegrityEnabled;
